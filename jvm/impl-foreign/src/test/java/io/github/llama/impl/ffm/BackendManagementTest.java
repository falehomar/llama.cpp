...
public class BackendManagementTest {
    ...
    public void testNumaInit() {
        ...
        try {
            ...
            llama_h.llama_numa_init(0); // GGML_NUMA_STRATEGY_DISABLED
        } finally {
            // Free the backend
            llama_h.llama_backend_free();
        }
    ...
    public void testTimeUs() {
        ...
        try {
            ...
            long timeUs = llama_h.llama_time_us();
            ...
            // Get time again
            long timeUs2 = llama_h.llama_time_us();
    ...
    public void testMaxDevices() {
        ...
        try {
            ...
            long maxDevices = llama_h.llama_max_devices();
    ...
    public void testSupportsMmap() {
        ...
        try {
            ...
            boolean supportsMmap = llama_h.llama_supports_mmap();
    ...
    public void testSupportsMlock() {
        ...
        try {
            ...
            boolean supportsMlock = llama_h.llama_supports_mlock();
    ...
    public void testSupportsGpuOffload() {
        ...
        try {
            ...
            boolean supportsGpuOffload = llama_h.llama_supports_gpu_offload();
    ...
    public void testSupportsRpc() {
        ...
        try {
            ...
            boolean supportsRpc = llama_h.llama_supports_rpc();
    ...
    public void testPrintSystemInfo() {
        ...
        try {
            ...
            var systemInfo = llama_h.llama_print_system_info();
